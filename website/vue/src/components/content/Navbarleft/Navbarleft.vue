    ...
    <div class="scroll-y scroll navbarleft">
      ...
      <div class="">
        <span class="showBar" @click="changeCollapse">
          <img
            src="~assets/img/Navbarleft/hide.svg"
            alt=""
            v-show="!isCollapse"
          />
          <img
            src="~assets/img/Navbarleft/show.svg"
            alt=""
            v-show="isCollapse"
          />
        </span>
...
<script>
import Basemenu from '@/components/common/BaseBackend/BaseMenu.vue'
...
export default {
  ...
  mounted () {
    ...
    this.menuList = origin.filter((unit) => unit.path === rootMenuPath)
  }
}
</script>
